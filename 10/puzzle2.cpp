...
{
    std::map<Coord, std::vector<Coord>> results;
    for (int y = 0; y < lines.size(); y++) {
        for (int x = 0; x < lines[y].size(); x++) {
            ...
            if (height == 0) {
                ...
                results.insert_or_assign(coord, std::vector<Coord> {});
                    ...
                    for (auto& direction : directions) {
                        ...
                        if (nextHeight - currentHeight == 1) {
                            if (nextHeight == 9) {
                                ...
                                results.at(coord).push_back(nextCoord);
                            } else {
                                /* std::cout << "inserted " << nextCoord.first << "," */
                                /*           << nextCoord.second << std::endl; */
                                ways.push_front({ nextCoord, nextHeight });
                            }
                        }
                    }
                }
